...
export default class TodoForm extends React.Component {
    ...
    addTodo = (e) => {
        ...
        this.props.addTodo(this.state.inputText, moment().format('LLLL'), this.state.body, this.state.complete);
    ...
    render() {
        ...
        : <div className="plus-container">
            <FontAwesomeIcon icon={faPlusSquare} size="3x"  color="green" onClick={this.toggleForm} />
          </div>
