...
Your job is to write the components to complete the Todo List application and getting as many of the tests to pass as you can. The tests are expecting that you have a TodoList component that renders a Todo component for each todo item. The 

##requirements for your Todo List app##

* input field that a user can type text into and submit data in the input field in order to create a new todo item. 

* mark any todo in the list as 'complete'. 
  * click on any of the todos in the list and have a strikethrough go through the individual todo. 

  * a todo item that has a strikethrough through it should still be clickable in order to allow completed items to no longer be marked as 'completed'. 

* have the root `App` component render your TodoList component. 
